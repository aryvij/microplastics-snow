...
file_name = 'output_rubber_tot.txt'
with open(file_name,'w') as f:
    ...
    f.write ("Comparison Umeå-Lueå-total Rubber")
    f.write (res.summary)
    ...
    f.write ("Comparison HT-LT-total Rubber")
    f.write (res.summary)
    ...
    f.write ("Comparison D1-D2-total Rubber")
    f.write (res.summary)

    #4.DISTANCE_FROM_EDGE_OF_ROAD

    #Distance_from_edge_of_road_Rubber_TOTAL
    df = pd.read_csv('MP_Data.csv')
    ...
    #Distance_from_edge_2.5_Rubber_TOTAL
    ...
    f.write ("Comparison 0.5-2.5-total Rubber")
    f.write (res.summary)
f.close()